...
class Environment:
    ...
    def __init__(
        ...
        grid_size=0.25,
        fov=100.0,
        offline_data_dir='~/Data/AI2Thor_Dataset/Scene_Data',
    ...
    def detection_add_depth_x_y(self,detection):
        return self.controller.get_depth_value_add_detection(detection)
